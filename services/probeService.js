    ...
    constructor(config, logger) {
        ...
        this._options = {
            ...
            onSendFailureDuringShutdown:
                this._config.onSendFailureDuringShutdown ||
                onSendFailureDuringShutdown, // [optional] called before sending each 503 during
            // both
        ...
        return new Promise((resolve, reject) => {
            ...
            server
                .listen(port, () => {
                    this._logger.log(
                        "info",
                        `Probe server is listening on port ${port}`
                    );
                    return resolve();
                })
                .on("error", (error) => {
